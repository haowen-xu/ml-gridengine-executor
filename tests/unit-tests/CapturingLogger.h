...
#ifndef ML_GRIDENGINE_EXECUTOR_TESTS_CAPTURINGLOGGER_H
#define ML_GRIDENGINE_EXECUTOR_TESTS_CAPTURINGLOGGER_H
...
#endif //ML_GRIDENGINE_EXECUTOR_TESTS_CAPTURINGLOGGER_H
